...
acil = PRANKBOTS.LINE()
acil.login(token="TOKEN_1")
acil.loginResult()

pb1 = PRANKBOTS.LINE()
pb1.login(token="TOKEN_2")
pb1.loginResult()

pb2 = PRANKBOTS.LINE()
pb2.login(token="TOKEN_3")
pb2.loginResult()
...
helpMessage ="""(༼༿ᵇᵒᵗˢⁱʰⁱʳˢ༾༽)
╔══༿༑ᵐᵃⁿᵗʳᵃ༑༾༓༱༓༼༐ᵇᵒᵗˢⁱʰⁱʳˢ༐༽══╗
║Me
║Add
║Cn "text"
║Clockname "text"
...
wait = {
    ...
    'timeline':False,
    'autoAdd':True,
    'message':"""❂••••AUTO ADD BY ༺ྉ༑ᵖᵉⁿʸⁱʰⁱʳˢ ᵇᵒᵗ༑ྉ༻••••❂\nhttps://www.youtube.com/channel/UCl3cMOdVtCmBxNCK6VqQK5g\n❂•••JANGAN 
LUPA DI SUBSCRIBE YA••••❂""",
    "lang":"JP",
    "comment1":"❂••••AUTO ADD BY ༺ྉ༑ᵖᵉⁿʸⁱʰⁱʳˢ ᵇᵒᵗ༑ྉ༻••••❂\nhttps://www.youtube.com/channel/UCl3cMOdVtCmBxNCK6VqQK5g\n❂•••JANGAN LUPA DI SUBSCRIBE YA••••❂",
...
#                else:
                ...
                if len(string.decode('utf-8')) <= 20:
                    ...
                    acil.sendText(msg.to,"􀜁􀇔􏿿semua nama botsihir telah di update menjadi\n👉 " + string + "👈")
...
#--------------------------------------------------------
                ...
                msg.contentMetadata = {'mid': 'u10bc9fb6bcc54250356717335889864f'}
                acil.sendMessage(msg)
                acil.sendText(msg.to,"❂•••••{༺ྉ༑ᵖᵉⁿʸⁱʰⁱʳˢ ᵇᵒᵗ༑ྉ༻}•••••❂")
                    ...
                    if msg.to in wait2['readPoint']:
                        if wait2["ROM"][msg.to].items() == []:
                            ...
                            for rom in wait2["ROM"][msg.to].items():
                                print rom
                                chiya += rom[1] + "\n"
                        acil.sendText(msg.to,"🔳🔲🔲Nah ketauan🔲🔲🔳 %s\n🔲🔳🔳Tercyduk🔳🔳🔲\n%s\nReading point creation date n time:😁😁\n[%s]" % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
                    else:
...
#-------------Fungsi Tagall User Start---------------#
            elif msg.text in ["Dor","Tagall","Absen","Tag"]:
                group = acil.getGroup(msg.to)
...
#-----------------------------------------------
                ...
                if msg.toType == 2:
                    ginfo = acil.getGroup(msg.to)
                    try:
                        acil.sendText(msg.to,"􀜁􀇔􏿿Bye Bye😘 jangan lupa subscribe channel youtube nya\nhttps://www.youtube.com/channel/UCl3cMOdVtCmBxNCK6VqQK5g"  + " :\n" + str(ginfo.name)  + "")
...
#-----------------------------------------------
                ...
                ginfo = acil.getGroup(msg.to)
                acil.sendText(msg.to,"Selamat Datang 😎😎kawan😘😘 Di Grup " + str(ginfo.name))
